local finity = {}
function finity:DraggingEnabled(frame, parent)
...
finity.dark_theme = { -- dark
	main_container = Color3.fromRGB(11, 11, 11),
	separator_color = Color3.fromRGB(200, 200, 200),
...
function finity.new(theme_name, gprojectName, thinProject)
	...
	finity:DraggingEnabled(self2.topbar,self2.container)
	...
	function self2:Category(name)
		...
		function category:Sector(name)
			...
			uilistlayout = nil
			--[[
			function sector:Label(name)
				local labelcheat = {}
				

				labelcheat.frame = finity:Create("Frame", {
					Name = name,
					BackgroundColor3 = Color3.new(1, 1, 1),
					BackgroundTransparency = 1,
					Size = UDim2.new(1, 0, 0, 25),
				...
				labelcheat.label = finity:Create("TextLabel", {
					Name = "Title",
					BackgroundColor3 = Color3.new(1, 1, 1),
					BackgroundTransparency = 1,
					Size = UDim2.new(1, 0, 1, 0),
				...
				labelcheat.container	= finity:Create("Frame", {
					Name = "Container",
				...
				function labelcheat.Update(name)
					labelcheat.label.Text = name
				end
