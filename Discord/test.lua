...
function DiscordLib:Window(text, idk)
	_G.visible = nil
	_G.transparency = nil
	if idk then
		_G.visible = false
	...
	Title.BackgroundTransparency = _G.transparency
	Title.Position = UDim2.new(0.107000001, 0, 0, 0)
	Title.Size = UDim2.new(0, 609, 0, 23)
	Title.Font = Enum.Font.Gotham
	Title.Text = "  ".. text
	Title.TextColor3 = Color3.fromRGB(235, 235, 235)
	Title.TextSize = 13.000
	Title.TextXAlignment = Enum.TextXAlignment.Left
	--Title.Visible = _G.hidetitletopframe
	...
	function ServerHold:Server(text, img)
		...
		--ServerTitleFrame.Dragging = true
		...
		--ServerTitle.Dragging = true
		MakeDraggable(ServerTitleFrame, MainFrame)
		...
		--ChannelTitleFrame.Draggable = true
		...
		--ChannelTitle.Draggable = true
		MakeDraggable(ChannelTitleFrame, MainFrame)
		...
		local ChannelHold = {}
		function ChannelHold:Channel(text, image)
			...
			function ChannelContent:Toggle(text,default,callback)
				...
				Toggle.BackgroundColor3 = Color3.fromRGB(78, 81, 85)
				...
				ToggleFrameCorner.CornerRadius = UDim.new(0, 9)
				...
				ToggleFrameCircleCorner.CornerRadius = UDim.new(1, 9)
			...
			function ChannelContent:Seperator()
				...
				Seperator2.BackgroundColor3 = _G.color2
...
local win = DiscordLib:Window("BROOO", false)
local serv = win:Server("", "")


local btns = serv:Channel("Toggles", "rbxassetid://7733960981")
