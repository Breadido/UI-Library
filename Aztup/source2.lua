...
local function initLibrary()
    ...
    do -- library funcs
        ...
        local ui_Settings = {
            ...
            scrollingBarColor = Color3.fromRGB(255, 41, 41);
            toggleColor = Color3.fromRGB(34, 34, 34);
            toggleBorderColor = Color3.fromRGB(255, 41, 41);
            boxColor = Color3.fromRGB(32, 32, 32);
            boxBorderColor = Color3.fromRGB(255, 41, 41);
			bordercolor2 = Color3.fromRGB(241, 41, 41); 
            gradientColorSection = ColorSequence.new{ColorSequenceKeypoint.new(0, Color3.fromRGB(220, 41, 41)), ColorSequenceKeypoint.new(1, Color3.fromRGB(200, 41, 41))};
            gradientColor = ColorSequence.new{ColorSequenceKeypoint.new(0, Color3.fromRGB(220, 41, 41)), ColorSequenceKeypoint.new(0, Color3.fromRGB(235, 41, 41)), ColorSequenceKeypoint.new(1, Color3.fromRGB(255, 74, 74))};
        ...
        MakeDraggable(main.bar.bottom,main)
        ...
        function library:CreateSection(name)
            ...
            function section:Label(labelName)
                ...
                --print(holder.label.Text)
                function LabelFunction:NewText(newtexto)
                    holder.label.Text = newtexto
                end
            ...
            function section:Slider(sliderName, properties, callback)
                ...
                local holder = library:Create("Frame", {
                    ...
                    library:Create("TextButton", {
                        Name = "slider";
                        BackgroundColor3 = Color3.fromRGB(34, 34, 34);
                        BorderColor3 = ui_Settings.bordercolor2;
            ...
            function section:Button(buttonName, callback)
				...
				holder.button.MouseButton1Click:Connect(function()
					game:GetService("TweenService"):Create(holder.button.label, TweenInfo.new(.1, Enum.EasingStyle.Quad), {TextTransparency = 1}):Play()
					wait(.09)
					game:GetService("TweenService"):Create(holder.button.label, TweenInfo.new(.1, Enum.EasingStyle.Quad), {TextTransparency = 0}):Play()
				end)
            end;
            ...
            function section:Dropdown(name, list, callback)
                ...
                local holder = library:Create("Frame", {
                    ...
                    library:Create("TextButton", {
                        Name = "dropdown";
                        BackgroundColor3 = ui_Settings.bordercolor2;
                        BorderColor3 = ui_Settings.bordercolor2;
                        Size = UDim2.new(1, 0, 0, 18);
                        AutoButtonColor = false;
                        Font = "SourceSans";
