...
if _G.Color == nil then _G.Color = Color3.fromRGB(255, 255, 0) end
if _G.Color2 == nil then _G.Color2 = Color3.fromRGB(186, 167, 0) end
-- Services
...
function library:CreateWindow(name, hidebutton)
    local window = { }
    window.name = name or ""
    window.size = UDim2.fromOffset(569,369) -- nice 69
